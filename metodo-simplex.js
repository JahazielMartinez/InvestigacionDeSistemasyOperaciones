 function jsimplex(div)
 {
     ...
     jsimplex.prototype.normalizar=function()
     {
        ...
        try
        {
            ...
            if (this.documentar)
            {
                ...
                smodelo = smodelo +"Xi = Variables de decisi&oacute;n<br> Si = Variables de holgura <br>Ai = Variables artificiales ";
         ...
         }else
         {
             ...
             }else
             {
                 ...
                 if (this.documentar)
                 {
                     ...
                     {
                         document.getElementById(div).innerHTML+="<br><br>Se encontro la solucion: ";
                     }
                 }
     ...
     jsimplex.prototype.gauss=function(ifila,icolumna)
     {
       ...
       s= s+ "<tr>";
       s= s+ "<td><b>Gauss-Jordan</b>:Renglon Pivote</td>";
       ...
       s= s+ "<tr>";
       s= s+ "<td>Ecuación Pivote convertida</td>";

       pivote = this.a[ifila][icolumna];

       if (pivote==0)
       {
           s= s +  "Se presenta un error: pivote igual a cero";
           return 0;
       }
